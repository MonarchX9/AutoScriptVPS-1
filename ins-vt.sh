...
# install v2ray
wget https://raw.githubusercontent.com/EvoTeamMalaysia/AutoScript/main/go.sh && chmod +x go.sh && ./go.sh
rm -f /root/go.sh
...
wget -O del-vless "https://raw.githubusercontent.com/EvoTeamMalaysia/AutoScript/main/del-vless.sh"
